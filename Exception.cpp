...
int getLength(char* msg)
{
	...
	for (int i = 0; msg[i] != 0; i++) //steps throught the message until it reaches the end of the string
	{
		length++;
	}
...
{
	m_length = 0;
	m_msg = new char[m_length + 1]; //dynamicaly allocates memory for the message
}
